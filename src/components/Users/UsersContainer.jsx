...
import { getCurrentPage, getFollowingInProgress, getIsFetching, 
    getPageSize, getPortionSize, getTotalUsersCount, getUsersList, getThemeValue } from '../../redux/selectors/users-selectors';
...
class UsersContainer extends  React.Component  {
    ...
    render() {
        return <div className={styles.usersPage}>
                ...
                <Users themeType = { this.props.themeType}
